...
Level.prototype.createLava = function(blocks){
  blocks.push(new Block({x: 384, y: 576, image: './images/lava.png'}));
  blocks.push(new Block({x: 448, y: 576, image: './images/lava.png'}));
  blocks.push(new Block({x: 512, y: 576, image: './images/lava.png'}));
  blocks.push(new Block({x: 576, y: 576, image: './images/lava.png'}));
};

Level.prototype.addDoor = function(blocks){
  blocks.push(new Block({x: 704, y: 512, image: './images/door.png', collisions: [1, 2, 4]}));
};
