...
Game.prototype.drawLevelTwo = function(context) {
  ...
  this.levelTwo.userInfoDraw.draw(this.levelTwo.firstPlayer, context, this.stage);
...
Game.prototype.drawLevelThree = function(context) {
  ...
  this.levelThree.userInfoDraw.draw(this.levelThree.firstPlayer, context, this.stage);
