...
/***/ function(module, exports, __webpack_require__) {
	...
	var Projectile = __webpack_require__(5);

	var Listener = function Listener(canvas, player, projectiles) {
	  this.canvas = canvas;
	  this.player = player;
...
/***/ function(module, exports, __webpack_require__) {
	...
	LevelOneLayout.prototype.createTopBoundary = function (blocks) {
	  this.xValues.forEach(function (value) {
	    blocks.push(new Block({ x: value, y: 0, collisions: [3], wall: true }));
	  });
	};

	LevelOneLayout.prototype.createBottomBoundary = function (blocks) {
	  this.xValues.forEach(function (value) {
	...
	LevelOneLayout.prototype.createLeftBoundary = function (blocks) {
	  this.yValues.forEach(function (value) {
	    blocks.push(new Block({ x: 0, y: value, collisions: [2], wall: true }));
	  });
	};

	LevelOneLayout.prototype.createRightBoundary = function (blocks) {
	  this.yValues.forEach(function (value) {
	    blocks.push(new Block({ x: 960, y: value, collisions: [4], wall: true }));
	  });
	};

	LevelOneLayout.prototype.createLava = function (blocks) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Player = __webpack_require__(3);
	var Projectile = __webpack_require__(5);
	var PortalController = __webpack_require__(9);
	...
	Detector.prototype.checkBlockTopPlayerCollision = function (player, block) {
	  ...
	  } else if (player.x >= block.x - 20 && player.x <= block.x + 63) {
	...
	Detector.prototype.checkBlockRightPlayerCollision = function (player, block) {
	  if (player.y >= block.y && player.y <= block.y + 63) {
	    if (player.x >= block.x + 25 && player.x <= block.x + 54) {
	      this.levelCompleteCheck(player, block);
	      if (this.bothPortalsOpen() && (block.bluePortal || block.orangePortal)) {
	        this.teleportPlayer(player, block);
	      } else if (block.lava) {
...
/***/ function(module, exports) {
	...
	UserInfoDraw.prototype.draw = function (player, context, level, levelAttempts) {
	  ...
	  context.fillText('Attempts: ' + levelAttempts, 100, this.y + 47);
	  return this;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Player = __webpack_require__(3);
	var Listener = __webpack_require__(4);
	var LevelTwoLayout = __webpack_require__(14);
	var Detector = __webpack_require__(8);
	var UserInfoDraw = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Player = __webpack_require__(3);
	var Listener = __webpack_require__(4);
	var LevelThreeLayout = __webpack_require__(16);
	var Detector = __webpack_require__(8);
	var UserInfoDraw = __webpack_require__(12);

	function LevelThree(canvas, score) {
	  this.blocks = [];
	  this.projectiles = { blue: null, orange: null };
	  this.firstPlayer = new Player({ x: 300, y: 500 });
	  this.listener = new Listener(canvas, this.firstPlayer, this.projectiles, score);
...
/***/ function(module, exports, __webpack_require__) {
	...
	LevelThreeLayout.prototype.createLeftBoundary = function (blocks) {
	  this.yValues.forEach(function (value) {
	    if (value !== 448 || value !== 256) {
	      blocks.push(new Block({ x: 0, y: value, collisions: [2], wall: true }));
	    }
	  });
	  blocks.push(new Block({ x: 0, y: 256, collisions: [1, 2], wall: true }));
	};
	...
	LevelThreeLayout.prototype.createRightBoundary = function (blocks) {
	  ...
	  blocks.push(new Block({ x: this.xValues[14], y: this.yValues[6], wall: true, collisions: [1, 2, 4] }));
	  blocks.push(new Block({ x: this.xValues[13], y: this.yValues[5], wall: true, collisions: [1, 2, 4] }));
	  ...
	  blocks.push(new Block({ x: this.xValues[12], y: this.yValues[6], wall: true, collisions: [1, 2, 4] }));
	  blocks.push(new Block({ x: this.xValues[12], y: this.yValues[7], wall: true, collisions: [] }));
	  blocks.push(new Block({ x: this.xValues[11], y: this.yValues[5], wall: true, collisions: [1, 2, 4] }));
	...
	LevelThreeLayout.prototype.createLava = function (blocks) {
	  blocks.push(new Block({ x: this.xValues[12], y: this.yValues[5], image: './images/lava.png', wall: false, lava: true, collisions: [1, 2, 3, 4] }));
	  blocks.push(new Block({ x: this.xValues[14], y: this.yValues[5], image: './images/lava.png', wall: false, lava: true, collisions: [1, 2, 3, 4] }));
	};
	...
	LevelThreeLayout.prototype.addObstacles = function (blocks) {
	  blocks.push(new Block({ x: this.xValues[1], y: this.yValues[5], wall: true, collisions: [1, 2, 3, 4] }));
	  blocks.push(new Block({ x: this.xValues[1], y: this.yValues[4], wall: true, collisions: [1, 2, 3, 4] }));
	  blocks.push(new Block({ x: this.xValues[1], y: this.yValues[3], wall: true, collisions: [1, 2, 3, 4] }));
	  blocks.push(new Block({ x: this.xValues[2], y: this.yValues[5], wall: true, collisions: [1, 2, 3, 4] }));
	  blocks.push(new Block({ x: this.xValues[2], y: this.yValues[4], wall: true, collisions: [1, 2, 3, 4] }));
	  blocks.push(new Block({ x: this.xValues[3], y: this.yValues[5], wall: true, collisions: [1, 2, 3, 4] }));
	  blocks.push(new Block({ x: this.xValues[5], y: this.yValues[5], wall: true, collisions: [1, 2, 3, 4] }));
	  blocks.push(new Block({ x: this.xValues[6], y: this.yValues[5], wall: true, collisions: [1, 2, 3, 4] }));
	  blocks.push(new Block({ x: this.xValues[7], y: this.yValues[7], wall: true, collisions: [1, 2, 3, 4] }));
	  blocks.push(new Block({ x: this.xValues[7], y: this.yValues[6], wall: true, collisions: [1, 2, 3, 4] }));
	  blocks.push(new Block({ x: this.xValues[7], y: this.yValues[5], wall: true, collisions: [1, 2, 3, 4] }));
	  blocks.push(new Block({ x: this.xValues[7], y: this.yValues[4], wall: true, collisions: [1, 2, 3, 4] }));
	  blocks.push(new Block({ x: this.xValues[7], y: this.yValues[3], wall: true, collisions: [1, 2, 3, 4] }));
	};
